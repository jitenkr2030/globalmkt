...
import { JapaneseMarketAdapter } from './japanese-market-adapter';
import { ChineseMarketAdapter } from './chinese-market-adapter';
import { HongKongMarketAdapter } from './hongkong-market-adapter';
import { KoreanMarketAdapter } from './korean-market-adapter';
import { SingaporeMarketAdapter } from './singapore-market-adapter';
import { NepalMarketAdapter } from './nepal-market-adapter';
import { IndianMarketAdapter } from './indian-market-adapter';
...
export class MarketAdapterFactory {
  ...
  static async createAdapter(marketId: string): Promise<BaseMarketAdapter> {
    ...
    switch (marketId) {
      case 'india':
        adapter = new IndianMarketAdapter(config);
        break;
      case 'nepal':
        adapter = new NepalMarketAdapter(config);
        break;
      case 'japan':
        adapter = new JapaneseMarketAdapter(config);
        break;
      case 'china':
        adapter = new ChineseMarketAdapter();
        break;
      case 'hongkong':
        adapter = new HongKongMarketAdapter();
        break;
      case 'korea':
        adapter = new KoreanMarketAdapter();
        break;
      case 'singapore':
        adapter = new SingaporeMarketAdapter();
        break;
      default:
  ...
  static getAllMarketStatuses(): Record<string, {
    ...
    const markets = ['india', 'japan', 'china', 'hongkong', 'korea', 'singapore', 'nepal'];
